...
void StaticMesh::Initialize(const std::vector<Vertex>& vertices, const std::vector<uint32_t>& indices)
{
	...
	GL_ASSERT(glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, Vertex::GetStride(), (void*)(offsetof(Vertex, uv))), "failed to define an array of generic vertex attribute data");
