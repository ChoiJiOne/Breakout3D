...
public:
	 ...
	 */
	void Initialize(const std::wstring& vsPath, const std::wstring& fsPath);
	 ...
	 * @param fsFile 프레그먼트 셰이더의 확장자(.frag)를 포함한 경로입니다.
	 */
	void Initialize(const std::wstring& vsPath, const std::wstring& gsPath, const std::wstring& fsPath);
